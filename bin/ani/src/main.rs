...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_subject_comments,
            commands::find_sibling_subtitles,
            ...
            commands::danmaku_search_episodes,
            commands::danmaku_fetch_by_episode_id,
            ...
            commands::win_is_always_on_top,
            commands::win_toggle_always_on_top,
            commands::win_set_size,
            commands::win_get_size,
